"""Assemble the self-contained "Poemes proteics" gallery (HTML).
...
results/poema-del-mes.html (everything inlined; no external requests).
"""
...
_TEMPLATE = r"""<title>Poemes proteics</title>
<style>
{{FONT}}
  :root{
